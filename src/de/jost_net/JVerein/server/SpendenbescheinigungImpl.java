		...
		implements Spendenbescheinigung
{
	...
	public SpendenbescheinigungImpl()
	 ...
	 * 
	 * @param buchung Die Buchung zum Hinzufügen
	 */
	@Override
	 ...
	 * 
	 * @param buchung Die Buchung, die der Spendenbescheinigung zugeordnet wird
	 */
	@Override
			...
			throws RemoteException
	{
		...
		map.put(SpendenbescheinigungVar.STEUERNUMMER.getName(),
				Einstellungen.getEinstellung().getSteuernummer());
		map.put(SpendenbescheinigungVar.BESCHEIDDATUM.getName(),
				new JVDateFormatTTMMJJJJ()
						.format(Einstellungen.getEinstellung().getBescheiddatum()));
		map.put(SpendenbescheinigungVar.BESCHEID6AAO.getName(),
				Einstellungen.getEinstellung().getVorlaeufig() ? "X" : "");
